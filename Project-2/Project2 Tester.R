# Step 0: Downloading the necessary files from the database
# Deaths
...
# Recoveries
download.file("https://raw.githubusercontent.com/CSSEGISandData/COVID-19/master/csse_covid_19_data/csse_covid_19_time_series/time_series_covid19_recoveries_global.csv", destfile = "recoveries_global.csv")
